# Generated by Powerlevel10k configuration wizard on 2025-03-11 at 15:18 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING="%BNORMAL"
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=6
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING="%BVISUAL"
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=5
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING="%BREPLACE"
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=4
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING="%BINSERT"
